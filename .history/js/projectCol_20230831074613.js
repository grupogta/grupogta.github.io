...
[
    ...
    ["En Ejecución",  "Reparación de torre Eléctrica ",  "Torre de Emergencia", "ISA", "../img/projects/proyectos03.jpg"]
];
...
function addDomProjects(project)
{
    ...
    cardNode.children[0].children[0].setAttribute("src", project[4] );
